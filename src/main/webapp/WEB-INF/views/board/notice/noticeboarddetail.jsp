					...
					<div class="col-lg-8 posts-list">
									...
									<div
										...
										<div class="detials">
											<c:if test="${board.no>1}">
												<a href="${root}/board/notice/select?no=${board.no-1}">
													<h4>Prev Post</h4>
												</a>
											</c:if>
										</div>
						...
						<div class="comment-form" style="margin: 0">
							...
							<form class="form-contact comment_form"
								action="${root}/board/notice/comment/insert" id="commentForm"
								method="post">
								<input type="hidden" value="${board.no}" name="noticeNo">
								...
								<div class="row">
									...
									<div class="col-11 comment" style="padding: 0">
										<div class="form-group" style="display: none"
											...
											<form class="form-contact comment_form"
												action="${root}/board/notice/comment/insert" id="replyForm${comment.groupNo}"
												method="post">
												<input type="hidden" value="${board.no}" name="noticeNo">
												...
												<div class="row">
													<div class="col-9">
														<div class="form-group" style="margin: 0">
															<textarea class="form-control w-100" name="comment"
																id="replycomment" cols="30" rows="4" placeholder="대댓글 남기기"></textarea>
														</div>
													</div>
													<div class="col-3">
														<div class="form-group ">															
					...
					<div class="col-lg-4">
						<div class="blog_right_sidebar">
							...
							<aside class="single_sidebar_widget tag_cloud_widget" >
								<a target="_blank" href=https://www.rankingdak.com/shop/detail.php?pno=305EC2F907E0FCBB74F06FEF40C9A4AC&gclid=EAIaIQobChMIjO3Mt4OZ7QIVQ9K8Ch3J0AniEAEYASAAEgKY7vD_BwE>
								<img src="/carrotmap/assets/img/ad/17796123250782582115.png" >
								</a>
							</aside>
...
// 	 대댓글 등록
	 $(".replytBtn1").click((e)=>{
		 ...
		 console.log(formdata)
      	 $.ajax({
      		 url: "http://localhost:8887/carrotmap/board/notice/comment/insert-rest",
      		 data: formdata,
      		 type:"POST",
      		 success: (data)=>{
	...
	<script>		
		  $("#boardBtn").click(()=>{		    	 
		    	  location.href = "/carrotmap/board/notice/list";
		  });
	</script>
